      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            ...
            relaciones como <strong>MySql</strong>, <strong>MongoDB</strong> y
            utilizo herramientas como <strong>Git</strong>,{" "}
            <strong>Slack</strong>, <strong>Notion</strong> y{" "}
            <strong>Notion</strong>. Considero que el aprendizaje constante es
            esencial en mi carrera y estoy siempre dispuesto a abordar nuevos
            temas. Mi objetivo personal es convertirme en un referente en el
            desarrollo de aplicaciones web sostenibles y de alto rendimiento,
            aportando soluciones innovadoras que impacten positivamente en la
